...
from hrnet_ocr import HighResolutionNet

class TOS_HRNet(nn.Module):
    def __init__(self, width, num_classes, block, layers, n_inputs, os=16, _print=True, ocr_width=256, small=False,
        ...
        # Context branch (ResNet)
        self.context_branch = HighResolutionNet(width, num_classes, ocr_width, small, norm_layer_param, align_corners)
            # <-------------- stopped here --------------> 
        # Edge branch
        n_layers = 2
        self.grad1 = EncoderBlock(4, 16, 256, n_layers, True, 1./4)
